...
for epoch in range(HyperParameter.EPOCH):
    ...
    with torch.no_grad():
        ...
        print(f"[Val] f1 : {val_f1_mask:4.2%}, acc : {val_acc_mask:4.2%}, loss: {val_loss_mask:4.2} || best f1 : {best_val_f1_mask:4.2%}, best acc : {best_val_acc_mask:4.2%}, best loss: {best_val_loss_mask:4.2}")
        print(f"[Val] f1 : {val_f1_age:4.2%}, acc : {val_acc_age:4.2%}, loss: {val_loss_age:4.2} || best f1 : {best_val_f1_age:4.2%}, best acc : {best_val_acc_age:4.2%}, best loss: {best_val_loss_age:4.2}")
        print(f"[Val] f1 : {val_f1_gender:4.2%}, acc : {val_acc_gender:4.2%}, loss: {val_loss_gender:4.2} || best f1 : {best_val_f1_gender:4.2%}, best acc : {best_val_acc_gender:4.2%}, best loss: {best_val_loss_gender:4.2}")
